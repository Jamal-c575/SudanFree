...
class ImageCacheConfig {
  ...
  static const ResolutionPreset thumbnail = ResolutionPreset(width: 200, height: 200, quality: 'auto');
  
  /// Medium resolution (for card views, post images)
  static const ResolutionPreset medium = ResolutionPreset(width: 600, height: 600, quality: 'auto');
  
  /// High resolution (for detail views, full-screen)
  static const ResolutionPreset high = ResolutionPreset(width: 1200, height: 1200, quality: 'auto');
  
  /// Full resolution (for gallery, zoom views)
  static const ResolutionPreset full = ResolutionPreset(width: 2000, height: 2000, quality: 'auto');
}
