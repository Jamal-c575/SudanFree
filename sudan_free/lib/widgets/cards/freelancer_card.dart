...
class FreelancerCard extends StatelessWidget {
      ...
      builder: (ctx) => SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                Localizations.localeOf(context).languageCode == 'ar' ? 'تواصل مع ${freelancer.name}' : 'Contact ${freelancer.name}',
              ...
              ListTile(
                ...
                onTap: () async {
                  Navigator.pop(ctx);
                  final phone = freelancer.phoneNumber ?? freelancer.whatsappNumber;
  ...
  Widget build(BuildContext context) {
    final totalStars = RankUtils.calculateTotalStars(freelancer.rating, freelancer.reviewsCount);
    final locale = Localizations.localeOf(context).languageCode;
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: freelancer.profileImageUrl != null
                          ? CachedNetworkImage(
                              imageUrl: CloudinaryService.getOptimizedUrl(freelancer.profileImageUrl!, width: 200, quality: 'auto'),
                              fit: BoxFit.cover,
                              memCacheWidth: 200,
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      height: 14,
                      decoration: BoxDecoration(
                        color: freelancer.isAvailable ? AppColors.success : AppColors.error,
                  ...
                  if (isRanked)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Icon(rankInfo.icon, size: 12, color: Colors.white),
                      ),
                    ),
                ],
              ),
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        if (freelancer.skills.isNotEmpty) ...[
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Text(
                                freelancer.skills.where((s) => s.toLowerCase() != 'other').take(2).map((skill) => JobTitlesUtils.getLocalizedTitle(skill, locale)).join(' • '),
                                style: TextStyle(
                                  fontSize: 11,
                    ...
                    if (freelancer.state != null)
                      Row(
                        children: [
                          Icon(Icons.location_on, size: 12, color: Theme.of(context).iconTheme.color?.withValues(alpha: 0.7) ?? Colors.grey),
                          const SizedBox(width: 4),
                          Expanded(
                            child: Text(
                              freelancer.locality != null && freelancer.state != null
                                  ? '${SudanLocations.getLocalityName(freelancer.locality!, locale)} - ${SudanLocations.getStateName(freelancer.state!, locale)}'
                                  : (freelancer.state != null ? SudanLocations.getStateName(freelancer.state!, locale) : ''),
                              style: TextStyle(
                                fontSize: 11,
  ...
  Widget _buildInitials() {
    return Container(
      ...
      child: Icon(Icons.person, size: 40, color: Colors.grey.withValues(alpha: 0.5)),
    );
  }
}
...
class FreelancerGridCard extends StatelessWidget {
            ...
            Expanded(
              ...
              child: ClipRRect(
                ...
                child: Container(
                  ...
                  child: freelancer.profileImageUrl != null
                      ? CachedNetworkImage(
                          imageUrl: CloudinaryService.getOptimizedUrl(freelancer.profileImageUrl!, width: 400, quality: 'auto'),
                          fit: BoxFit.cover,
                          memCacheWidth: 400,
  ...
  Widget _buildGridInitials() {
    return Container(
      color: Colors.grey.withValues(alpha: 0.1),
      child: Icon(Icons.person, size: 50, color: Colors.grey.withValues(alpha: 0.5)),
    );
  }
}
