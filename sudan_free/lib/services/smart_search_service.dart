...
class SmartSearchService {
  ...
  static const Map<String, List<String>> _jobSynonyms = {
    ...
    // النقل
    'سائق': ['سواق', 'توصيل', 'نقل عفش', 'ترحيل', 'مشاوير'],
    'نقل': ['سائق', 'سواق', 'توصيل', 'ناقل', 'ترحيل', 'نقل عفش'],
    
    // الطبخ
    'طباخ': ['طبخ', 'شيف', 'طاهي', 'صناعة طعام'],
    'شيف': ['طباخ', 'طبخ', 'طاهي'],
    ...
    // الأجهزة الإلكترونية
    'إلكترونيات': ['اجهزه', 'أجهزة', 'لابتوب', 'حاسوب', 'كمبيوتر', 'شاشات', 'صيانة اجهزة'],
