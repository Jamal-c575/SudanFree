  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Selector<ChatProvider, _ChatListState>(
        selector: (_, provider) => _ChatListState(provider.chats, provider.isLoading),
        builder: (context, state, _) {
          ...
          if (chats.isEmpty) {
            return EmptyStateWidget(
              ...
              title: locale == 'ar' ? 'لا توجد محادثات سابقة' : 'No previous chats',
              subtitle: locale == 'ar' 
                              ...
                              children: [
                                ...
                                CircleAvatar(
                                  ...
                                  backgroundImage: otherImage != null && otherImage.isNotEmpty
                                      ? CachedNetworkImageProvider(otherImage, maxWidth: 150, maxHeight: 150)
                                      : null,
