...
class _DigitalIdCardScreenState extends State<DigitalIdCardScreen> {
  ...
  Future<void> _shareCard() async {
    ...
    try {
      ...
      final file = File('${dir.path}/sudanfree_${_isFlipped ? 'qr' : 'id'}_${widget.user.id}.png');
        ...
        children: [
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Icon(Icons.verified_user, color: AppColors.sudanGold, size: 18),
                        ),
                            ...
                            child: user.profileImageUrl != null
                                ? CachedNetworkImage(
                                    imageUrl: CloudinaryService.getOptimizedUrl(
                                      user.profileImageUrl!, width: 200, quality: 'auto'),
                                    fit: BoxFit.cover,
                                  )
                                : Container(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: user.skills.take(4).map((skill) => Container(
                              ...
                              child: Text(
                                JobTitlesUtils.getLocalizedTitle(skill, isAr ? 'ar' : 'en'),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        if (user.state != null) ...[
                          Icon(Icons.location_on, color: Colors.white.withValues(alpha: 0.4), size: 14),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.qr_code_2, color: Colors.white.withValues(alpha: 0.3), size: 16),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: QrImageView(
              data: 'https://sudanfree.com/sudan-free.html?profileId=${user.id}',
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.touch_app, color: Colors.white.withValues(alpha: 0.5), size: 16),
              const SizedBox(width: 8),
              Text(
